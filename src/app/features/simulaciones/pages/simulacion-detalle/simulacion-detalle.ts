...
@Component({
  selector: 'app-simulacion-detalle-page',
  standalone: true,
  imports: [
    CommonModule,
    RouterLink,
  ...
  templateUrl: './simulacion-detalle.html',
  styleUrl: './simulacion-detalle.css',
})
export class SimulacionDetallePageComponent implements OnInit {
