...
export interface AdministradorUsuarioFormularioValue {
  nombre: string;
  correo: string;
  password: string;
  rol: string;
...
@Component({
  selector: 'app-administrador-usuario-formulario',
  imports: [
    CommonModule,
    ReactiveFormsModule,
    AppModalComponent,
  ...
  templateUrl: './administrador-usuario-formulario.html',
  styleUrl: './administrador-usuario-formulario.css',
})
export class AdministradorUsuarioFormularioComponent {
  private readonly formBuilder = inject(FormBuilder);

  readonly mode = input<'create' | 'edit'>('create');
  readonly roles = input<AdministradorRol[]>([]);
  readonly departments = input<AdministradorDepartamento[]>([]);
  readonly initialValue = input<AdministradorUsuario | null>(null);
  readonly pending = input(false);
  readonly serverError = input<string | null>(null);

  readonly save = output<AdministradorUsuarioFormularioValue>();
  ...
  private resolveDefaultRole(roles: AdministradorRol[]): string {
