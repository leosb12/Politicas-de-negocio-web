...
@Component({
  selector: 'app-administrador-servicios-ia-page',
  standalone: true,
  imports: [
    CommonModule,
    LucideAngularModule,
  ...
  templateUrl: './administrador-servicios-ia.html',
  styleUrl: './administrador-servicios-ia.css',
})
export class AdministradorServiciosIaPageComponent {
