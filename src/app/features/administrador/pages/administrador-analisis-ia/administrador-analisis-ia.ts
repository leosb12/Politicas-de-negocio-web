...
@Component({
  selector: 'app-administrador-analisis-ia-page',
  standalone: true,
  imports: [
    CommonModule,
    LucideAngularModule,
  ...
  templateUrl: './administrador-analisis-ia.html',
  styleUrl: './administrador-analisis-ia.css',
})
export class AdministradorAnalisisIaPageComponent implements OnInit {
