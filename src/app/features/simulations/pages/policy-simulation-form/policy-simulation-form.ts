...
import { PoliticaNegocio } from '../../../admin/models/politica.model';
import { PoliticaService } from '../../../admin/services/politica.service';
import {
  SimulationResult,
...
@Component({
  selector: 'app-policy-simulation-form-page',
  standalone: true,
  imports: [
    CommonModule,
    FormsModule,
  ...
  templateUrl: './policy-simulation-form.html',
  styleUrl: './policy-simulation-form.css',
})
export class PolicySimulationFormPageComponent implements OnInit {
