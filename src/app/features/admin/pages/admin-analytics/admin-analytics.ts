...
import { AdminAnalyticsAiSectionComponent } from '../../components/analytics-ai-section/analytics-ai-section';
import { AnalyticsKpiCardComponent } from '../../components/analytics-kpi-card/analytics-kpi-card';
import {
...
@Component({
  ...
  imports: [
    ...
    AdminAnalyticsAiSectionComponent,
  ],
...
export class AdminAnalyticsPageComponent implements OnInit {
  ...
  readonly summary = signal<AdminAnalyticsDashboardSummary | null>(null);
