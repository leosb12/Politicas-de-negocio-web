...
} from '../../components/admin-department-form/admin-department-form';
import {
  AdminDepartment,
...
export class AdminDepartmentsPageComponent {
  private readonly adminDepartmentsService = inject(AdminDepartmentsService);
  ...
  readonly selectedDepartment = signal<AdminDepartment | null>(null);
  ...
  readonly usersModalDepartment = signal<AdminDepartment | null>(null);
  readonly usersByDepartment = signal<AdminUser[]>([]);
  ...
  openEditDepartment(department: AdminDepartment): void {
  ...
  saveDepartment(formValue: AdminDepartmentFormValue): void {
  ...
  requestToggleStatus(department: AdminDepartment): void {
  ...
  requestDeleteDepartment(department: AdminDepartment): void {
    this.confirmState.set({
  ...
  openDepartmentUsers(department: AdminDepartment): void {
  ...
  private toggleStatus(department: AdminDepartment): void {
    const shouldDeactivate = department.activo;
  ...
  private deleteDepartment(department: AdminDepartment): void {
    this.confirmPending.set(true);
    this.actionLoadingDepartmentId.set(department.id);
  ...
  private reassignUsers(departamentoId: string): void {
    const payload: ReassignDepartmentUsersRequest = {
